...
public class ActivityFImages extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabaseRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                mAdapter=new ImageAdapter(ActivityFImages.this,mUploads);
            ...
            public void onCancelled(DatabaseError databaseError) {
                ...
                Toast.makeText(ActivityFImages.this,databaseError.getMessage(), Toast.LENGTH_SHORT).show();
                mProgress_circle.setVisibility(View.INVISIBLE);
            }
        });
    }
